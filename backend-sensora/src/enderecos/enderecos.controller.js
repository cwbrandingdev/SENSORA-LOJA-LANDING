...
var EnderecosController = function () {
    var _classDecorators = [(0, common_1.Controller)('enderecos'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard)];
    ...
    var EnderecosController = _classThis = /** @class */ (function () {
        function EnderecosController_1(enderecosService) {
            this.enderecosService = (__runInitializers(this, _instanceExtraInitializers), enderecosService);
        }
        EnderecosController_1.prototype.findMine = function (user) {
            return this.enderecosService.findByUsuario(user.id);
        };
        EnderecosController_1.prototype.findOne = function (id, user) {
            return this.enderecosService.findOneForUsuario(id, user.id);
        };
        EnderecosController_1.prototype.create = function (dto, user) {
            return this.enderecosService.create(user.id, dto);
        };
        EnderecosController_1.prototype.update = function (id, dto, user) {
            return this.enderecosService.update(id, user.id, dto);
        };
        EnderecosController_1.prototype.remove = function (id, user) {
            return this.enderecosService.remove(id, user.id);
        };
        return EnderecosController_1;
    }());
    __setFunctionName(_classThis, "EnderecosController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _findMine_decorators = [(0, common_1.Get)()];
        ...
        EnderecosController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return EnderecosController = _classThis;
}();
