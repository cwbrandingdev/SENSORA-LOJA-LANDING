...
var ClientesController = function () {
    var _classDecorators = [(0, common_1.Controller)('clientes'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), roles_decorator_1.Roles.apply(void 0, roles_constants_1.STAFF_ROLES)];
    ...
    var ClientesController = _classThis = /** @class */ (function () {
        ...
        ClientesController_1.prototype.create = function (createClienteDto) {
            return this.clientesService.create(createClienteDto);
        };
        ClientesController_1.prototype.update = function (id, updateClienteDto) {
