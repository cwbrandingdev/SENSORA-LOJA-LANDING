...
var JwtStrategy = function () {
    ...
    var JwtStrategy = _classThis = /** @class */ (function (_super) {
        ...
        function JwtStrategy_1(configService, usuariosService) {
            var _a;
        ...
        JwtStrategy_1.prototype.validate = function (payload) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usuariosService.buscarAtivoPorId(payload.sub)];
                        case 1:
                            usuario = _a.sent();
                            if (!usuario || !usuario.ativo) {
                                throw new common_1.UnauthorizedException('Sessão inválida ou usuário desativado.');
                            }
                            return [2 /*return*/, {
                                    id: usuario.id,
                                    email: usuario.email,
