...
export default function CookieConsentBanner() {
  ...
  return (
    <div
      ...
      onClick={isDialog ? (e) => e.target === e.currentTarget && close() : undefined}
    >
      <div
          ...
          {panel === "banner" ? (
            <>
              <p className="text-sm leading-relaxed text-slate-600">
                Usamos cookies e armazenamento local <strong>essenciais</strong>{" "}
                para login, carrinho e checkout. Cookies{" "}
                <strong>opcionais</strong> (como medição de audiência) só são
                usados se você consentir, conforme a LGPD.{" "}
                <Link
            ...
            <>
              <div>
                ...
                <p className="mt-2 text-sm leading-relaxed text-slate-600">
                  Você pode alterar ou revogar seu consentimento a qualquer
                  momento. Recusar opcionais não impede o uso da loja.
                </p>
              </div>
