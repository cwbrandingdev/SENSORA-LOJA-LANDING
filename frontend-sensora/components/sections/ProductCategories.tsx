...
export default function ProductCategories() {
  return (
    <div className="bg-[#f5f2ed]">
      {/* pb reduzido para, somado ao pt de LatestReleases logo abaixo
          (mesmo fundo), dar ~120/176/208px de vão entre o grid de
          categorias e "Conheça os últimos lançamentos" — o py cheio dos
          dois lados deixava um vazio de até ~320px. */}
      <section
        aria-labelledby="produtos-heading"
        className="bg-[#f5f2ed] relative mx-auto max-w-7xl overflow-hidden px-6 pt-16 pb-15 sm:pt-32 sm:pb-22 lg:px-10 lg:pt-40 lg:pb-26"
      >
